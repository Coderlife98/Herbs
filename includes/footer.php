<footer class="site-footer">
                ...
                <div class="container">
                    <div class="site-footer__top-inner">
                        <div class="site-footer-shape-1 float-bob-x"
                            style="background-image: url(assets/images/shapes/.png);"></div>
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                <div class="footer-widget__column footer-widget__about">
                                    <div class="footer-widget__logo">
                                        <a href="index.html"><img src="./assets/images/resources/logo.png" class="logoHeight" 
                                                alt=""></a>
                                    </div>
        ...
        <div class="added_bg container-fluid ">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12 py-2">
                         <p class="mb-0 text-center">&copy; Copyright 2024 by <a href="./index.php">yogherbs.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
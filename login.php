...
<body class="custom-cursor" style="background-color: black;color:#bbb">
    ...
    <?php include("./includes/navbar.php");?>
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url(assets/images/backgrounds/login.jpg)">
            </div>
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-7 my-3">
                        <div>
                            <img src="./assets/images/backgrounds/login.png" class="sm-width-full" alt="">
                        </div>
                    </div>
                    <div class="col-12 col-lg-5 my-3">
                        <div class="col-12">
                            <h3 class=" text-warning py-4">Login Here</h3>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="">
                                <div class="contact-form__input-box">
                                    <input type="text" placeholder="Email Id" class="input_bg"  name="Subject" required>
                                </div>
                            </div>
                            <div class="">
                                <div class="contact-form__input-box">
                                    <input type="Password" placeholder="Password" class="input_bg w-100 p-3 setrrr"  name="Password" required>
                                </div>
                            </div>
